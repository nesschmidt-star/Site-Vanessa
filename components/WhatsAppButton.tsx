...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-2xl hover:bg-[#20BD5A] hover:scale-110 transition-all duration-300 animate-bounce-slow group border-4 border-white"
    ...
    >
      ...
      <span className="absolute right-16 bg-gray-900 text-white text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg">
        Agende sua consulta!
      </span>
    </a>
  );
